            ...
            <div class="card-body py-4">
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ $count->action_date }}" type="text" readonly class="form-control"/>
                    </div>
                    @endif
                </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ ($count->department_id == 'all' || empty($count->department_id)) ? "All" : $count->department->name }}" type="text" readonly class="form-control"/>
                    </div>
                </div>
