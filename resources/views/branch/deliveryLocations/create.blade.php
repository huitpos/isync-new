<x-default-layout>
    ...
    <div class="card">
        <div class="card-body py-4">
            <form class="mt-3" action="{{ route('branch.delivery-locations.store', ['companySlug' => $company->slug, 'branchSlug' => $branch->slug]) }}" method="POST" novalidate enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ old('unit_floor_number') }}" autocomplete="off" name="unit_floor_number" type="text" class="form-control @error('unit_floor_number') is-invalid @enderror" placeholder="Unit / Floor Number" required/>
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ old('street') }}" autocomplete="off" name="street" type="text" class="form-control @error('street') is-invalid @enderror" placeholder="Street" required/>
