            ...
            <form class="mt-3" action="{{ route('admin.clients.store') }}" method="POST" novalidate enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input class="form-check-input" {{ old('auto_round_off_srp') ? 'checked' : '' }} name="auto_round_off_srp" type="checkbox" value="1"/>
                        <label>
                            Auto round off srp
                        </label>
                    </div>
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input class="form-check-input" {{ old('auto_update_srp') ? 'checked' : '' }} name="auto_update_srp" type="checkbox" value="1"/>
                        <label>
                ...
                <div class="mb-4">
                    <label class="form-label">Confirm Paswword</label>
                    <div data-kt-password-meter="true">
                        <div>
                            <div class="position-relative mb-3">
