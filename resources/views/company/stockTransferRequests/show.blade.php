<x-default-layout>
    ...
    <div class="card">
        <form class="mt-3" action="{{ route('company.stock-transfer-requests.update', ['companySlug' => $company->slug, 'stock_transfer_request' => $str->id]) }}" method="POST" novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card-body py-4">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ ($str->department_id == 'all' || empty($str->department_id)) ? "All" : $str->department->name }}" type="text" readonly class="form-control"/>
                    </div>
                </div>
                ...
                <div class="mt-7">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-<?= $str->status != 'approved' ? '12' : '6' ?>">
