<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('company.departments.create', $company) }}
    @endsection

    <div class="card">
        <div class="card-body py-4">
            <form class="mt-3" action="{{ route('company.departments.store', ['companySlug' => $company->slug]) }}" method="POST" novalidate enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ old('name') }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Department Name" required/>
