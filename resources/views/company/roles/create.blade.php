                                    ...
                                    <tbody>
                                        @foreach ($companyPermissions as $permission)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <input name="permission[]" value="{{ $permission->id }}" type="checkbox" data-permission-id="{{ $permission->id }}" class="form-check-input permission-parent">
                                                </td>
                                            </tr>
                                            ...
                                            @foreach ($permission->children as $child)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <input name="permission[]" value="{{ $child->id }}" data-parent-id="{{ $child->parent_id }}" type="checkbox" class="form-check-input permission-child" data-permission-id="{{ $child->id }}">
                                                    </td>
                                                </tr>
                                                ...
                                                @foreach ($child->children as $grandchild)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <input name="permission[]" value="{{ $grandchild->id }}" data-parent-id="{{ $grandchild->parent_id }}" type="checkbox" class="form-check-input permission-grandchild" data-grandparent-id="{{ $permission->id }}">
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endforeach
