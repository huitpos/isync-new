            ...
            <div class="card-body py-4">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ $pr->action_date }}" type="text" readonly class="form-control"/>
                    </div>
                </div>
                @endif
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ ($pr->department_id == 'all' || empty($pr->department_id)) ? "All" : $pr->department->name }}" type="text" readonly class="form-control"/>
                    </div>
                </div>
