    ...
    <div class="card">
        <div class="card-body py-4">
            <form class="mt-3" action="{{ route('company.discount-types.store', ['companySlug' => $company->slug]) }}" method="POST" novalidate enctype="multipart/form-data">
                ...
                <div class="mb-4 mt-5">
                    <input value="1" name="is_zero_rated" class="form-check-input" type="checkbox" id="is_zero_rated">
                ...
                <div class="mb-4 mt-5">
                    <input value="1" name="is_manual" class="form-check-input" type="checkbox" id="is_zero_rated">
                    <label class="form-check-label" for="is_zero_rated">
                        Is Manual
                    </label>
                </div>
