        ...
        <div class="card-body py-4">
            <form class="mt-3" action="{{ route('company.discount-types.update', ['companySlug' => $company->slug, 'discount_type' => $discountType->id]) }}" method="POST" novalidate enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ old('discount') ?? $discountType->discount }}" name="discount" type="number" class="form-control @error('discount') is-invalid @enderror" placeholder="Discount" required/>
