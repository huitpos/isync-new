                ...
                <div class="tab-content">
                    <div class="tab-pane fade {{ empty($branchSrpsErrors) ? 'show active' : '' }}" id="kt_tab_pane_1" role="tabpanel">
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ old('uom_cost') ?? $product->uom_cost }}" name="uom_cost" type="number" class="form-control @error('uom_cost') is-invalid @enderror" placeholder="UOM Cost" required/>
                        ...
                        <div class="mt-7">
                            ...
                            <div class="repeater">
                                ...
                                <div class="form-group mt-5">
                                    <button type="button" data-repeater-create="" class="btn btn-sm btn-light-primary">
                                    <i class="fa-solid fa-plus fs-2"></i>Add Bundled Item</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-7">
                            ...
                            <div class="repeater">
                                ...
                                <div class="form-group mt-5">
                                    <button type="button" data-repeater-create="" class="btn btn-sm btn-light-primary">
                                    <i class="fa-solid fa-plus fs-2"></i>Add Discount</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach($srpBranches as $branch)
                                        @php
                                            ...
                                            $srp = isset($branch->products[0]) && !empty($branch->products[0]->pivot?->price) && $branch->products[0]->pivot?->price > 0 ? $branch->products[0]->pivot?->price : $product->srp;
                                            $cost = isset($branch->products[0]) && !empty($branch->products[0]->pivot?->cost) && $branch->products[0]->pivot?->cost > 0 ? $branch->products[0]->pivot?->cost : $product->cost;
                                            $markup = isset($branch->products[0]) && !empty($branch->products[0]->pivot?->markup) && $branch->products[0]->pivot?->markup > 0 ? $branch->products[0]->pivot?->markup : $product->markup;
