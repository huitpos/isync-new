...
class PermissionSeeder extends Seeder
{
    ...
    private function getPermissionsList(): array
    {
        return [
            ...
            ['name' => 'Branch Dashboard/Transaction Count', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Total Net Amount', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Total Cost Amount', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Profit', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Transaction', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Transaction/Completed Transactions', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Transaction/Pending Transactions', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
            ['name' => 'Branch Dashboard/Transaction/Voided Transactions', 'guard_name' => 'web', 'level' => 'branch_user', 'route' => 'branch.dashboard', 'parent' => 'Branch Dashboard'],
