...
use App\Models\ProductDisposalReason as Model;
...
class ProductDisposalReasonsDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ->addColumn('actions', function (Model $data) {
                return view('company.datatables._actions', [
                    'param' => ['product_disposal_reason' => $data->id, 'companySlug' => $data->company->slug],
                    'route' => 'company.product-disposal-reasons',
                ]);
            });
    }
